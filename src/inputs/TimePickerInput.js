...
export default function TimePickerInput({name, onChange, errors, label, required}) {
	...
	return (
		<div className="w-full flex flex-col">
			...
			<input type="time" name={name} required={required} className={inputClasses} onChange={onChange}/>
		</div>
	);
}